        ...
        <div class="row">
            <div class="col-md-12">
                <div class="au-breadcrumb-content">
                    <form class="au-form-icon--sm" action="<?= \yii\helpers\Url::to(['lea/search']) ?>" method="get" >
                    ...
                    <?php if(!empty($manufactures)) : ?>
                        <div class="col-md-4">
                            <select name="select" id="select-manufacture" class="form-control" data-value="lea">
                    ...
                    <table class="table table-data2">
                        ...
                        <?php if(!empty($products)) : ?>
                            ...
                            <?php foreach ($products as $product) : ?>
                                <?php $last_update = \app\models\LeaUpdates::find()->where(['sku_product' => $product->sku])->andWhere(['!=', 'price' , $product->price])->andWhere(('update_at >= DATE_SUB(CURRENT_DATE, INTERVAL 7 DAY)'))->orderBy(['update_at' => SORT_DESC])->one(); ?>
                                ...
                                <?php $updates = \app\models\LeaUpdates::find()->select(['price' , 'update_at', 'sku_product'])->where(['sku_product' => $product->sku])->orderBy(['update_at' => SORT_ASC])->all(); ?>
