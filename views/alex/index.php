            ...
            <div class="col-md-12">
                <div class="au-breadcrumb-content">
                    ...
                    <?php if(!empty($manufactures)) : ?>
                        <div class="col-md-4">
                            <select name="select" id="select-manufacture" class="form-control" data-value="alex">
                    ...
                    <table class="table table-data2">
                        ...
                        <?php if(!empty($products)) : ?>
                            ...
                            <?php foreach ($products as $product) : ?>
                                <?php $last_update = \app\models\AlexmeatUpdates::find()->where(['sku_product' => $product->sku])->andWhere(['!=', 'price' , $product->price])->andWhere(('update_at >= DATE_SUB(CURRENT_DATE, INTERVAL 7 DAY)'))->orderBy(['update_at' => SORT_DESC])->one(); ?>
