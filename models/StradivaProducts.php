...
/**
 * This is the model class for table "stradiva_products".
 *
 * @property int $id
 ...
 */
class StradivaProducts extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'stradiva_products';
    }

    public function getUpdates()
    {
        return $this->hasMany(StradivaUpdates::className(), ['sku_product' => 'sku']);
    }
